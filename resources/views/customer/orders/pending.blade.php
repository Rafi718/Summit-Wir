...
@section('title', 'Pesanan Pending | SummitWirr')
        ...
        <div class="bg-white rounded-2xl shadow-sm overflow-hidden">
            <div class="flex flex-col md:flex-row">
                ...
                <div class="flex-1 p-6 md:p-8 lg:p-10">
                    ...
                    <h1 class="text-xl md:text-2xl font-bold text-gray-900 mb-6">Pesanan Pending</h1>
                            ...
                            @foreach($orders as $order)
                                <div class="bg-white border border-gray-200 rounded-xl p-5 hover:shadow-md transition">
                                    ...
                                    <div class="flex flex-wrap items-start justify-between gap-3 mb-4">
                                        ...
                                        <span class="px-3 py-1 bg-orange-100 text-orange-700 text-xs font-medium rounded-full whitespace-nowrap">
                                            Menunggu Pembayaran
                                        </span>
                                    </div>
